...
public class JwtHelper {
     ...
     */
    public static String issueJwt(String id, String subject, String issuer, String communityId, 
    		String deviceType, Long period, String roles, String permissions,String base64Security) {
        ...
        if (Strings.isNotBlank(communityId)){
        	jwt.claim("community", communityId);//所在社区
        }
    ...
    public static void main(String[] args) {
        ...
        String token = JwtHelper.issueJwt(UUID.randomUUID().toString(), "123456", "restapiuser", "c123456", null, 3600*1000L, "admin", "2", key);
