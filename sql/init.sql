...
CREATE TABLE `asset` (
  `asset_id` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键',
  `community_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '主键',
  `asset_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '资产类型',
  `asset_name` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '资产名字',
  `asset_position` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '位置',
  `asset_describe` text COLLATE utf8mb4_general_ci COMMENT '描述',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
